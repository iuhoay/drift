...
ActiveRecord::Schema[8.2].define(version: 2026_06_16_010000) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "reading_font", default: "mono", null: false
    t.string "reading_font_size", default: "medium", null: false
    t.datetime "updated_at", null: false
